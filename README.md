...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/green-hall-b21b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/green-hall-b21b
```

A live public deployment of this template is available at [https://green-hall-b21b.templates.workers.dev](https://green-hall-b21b.templates.workers.dev)
